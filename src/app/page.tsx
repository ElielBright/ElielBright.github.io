        ...
        <div className="container">
          ...
          >
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center', maxWidth: '800px', margin: '0 auto' }}>
              {["Python", "JavaScript", "TypeScript", "C++", "Node.js", "Express.js", "React", "React Native", "Next.js", "Vite", "MongoDB", "PostgreSQL", "Firebase", "AI Agents", "RAG Systems", "NLP", "Automation Systems", "Google Cloud", "Linux", "Contabo", "Docker", "Git", "Electron", "Arduino"].map((skill, index) => (
                <motion.div 
                  key={index}
